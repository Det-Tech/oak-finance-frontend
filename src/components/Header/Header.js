...
const Header = ({ links, isNightMode, setNightMode }) => {
  ...
  const YieldHub = () => (
    ...
    >
      ...
      <div className="flex flex-row items-center justify-center space-x-3 cursor-pointer" onClick={() => navigate("/")} >
        <img alt="" src={Logo} />
  ...
  return (
    <AppBar className={`${classes.appBar} ${classes.dark} ${classes.headerContainer} ${"bg-background"}`} position="relative">
