...
const networkBuyUrls = {
  ...
  11119: 'https://pad.hbittest.swap/',
  11120: 'https://pad.hbit.swap/', // TODO fill in our token's buy address
};
...
export const getNetworkVaults = (networkId = appNetworkId) => {
  switch (networkId) {
    ...
    case 11119:
      return indexBy(hbitPools, 'id');
    case 11120:
      return indexBy(hbittestPools, 'id');
    default:
      return {};
  }
};
...
export const getNetworkLaunchpools = (networkId = appNetworkId) => {
  switch (networkId) {
    ...
    case 11119:
      return indexBy(hbitStakePools, 'id');
    case 11120:
      return indexBy(hbitTestStakePools, 'id');
    default:
      return {};
  }
};
...
export const getNetworkTokens = () => {
  ...
  switch (chainId) {
    ...
    case 11119:
      return hbitAddressBook.tokens; // TODO add tokens
    case 11120:
      return hbitTestAddressBook.tokens; // TODO add tokens
    default:
      throw new Error(
...
export const getNetworkStables = () => {
  switch (window.REACT_APP_NETWORK_ID) {
    ...
    case 11119:
      return ['USDC', 'USDT', 'BUSD']; // TODO add HBIT stables
    case 11120:
      return ['USDC', 'USDT', 'BUSD']; // TODO add HBITTest stables
    default:
      return [];
  }
};
        ...
        providerOptions: {
          ...
          walletconnect: {
            ...
            options: {
              network: 'HBIT',
              rpc: {
                // 1: 'https://mainnet-rpc.hashbit.org',
                11119: 'https://mainnet-rpc.hashbit.org',
              },
            },
          },
          'custom-clover-polygon': {
          ...
          'custom-cb-polygon': {
            ...
            options: {
              appName: 'Oaki Finance',
              appLogoUrl: 'https://app.oaki.finance/static/media/BIFI.e797b2e4.png',
              darkMode: false,
            },
            package: WalletLink,
            connector: async (ProviderPackage, options) => {
              ...
              const provider = walletLink.makeWeb3Provider('https://mainnet-rpc.hashbit.org', 11119);
          ...
          walletconnect: {
            ...
            options: {
              ...
              rpc: {
                ...
                11120: 'https://testnet-rpc.hashbit.org',
              },
            },
          }         
        },
